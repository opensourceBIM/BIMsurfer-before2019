define([
    "bimsurfer/src/xeoViewer/geometry/vectorTextGeometry.js"
], function () {
     ...
     */
    XEO.BIMAxisHelper = function (cfg) {
        ...
        new XEO.Entity(scene, {
            Xgeometry: new XEO.CylinderGeometry(scene, {
                radiusTop: 9.0,
                radiusBottom: 9.0,
                height: 0.01,
                radialSegments: 20,
